...
$(document).ready(function() {
    ...
    //AJAX-instruktioner på document nivå...
    $(document).ajaxStart( function() {
        $('body').fadeTo(2000, 0.3);
    });

    $(document).ajaxComplete( function() {
        $('body').fadeTo(2000, 1.0);
    });
            ...
            */
            ...
            let request = $.ajax({
                ...
                'data' : {
                    ...
                    'imgHeight' : oGameData.imgHeight,
                    'imgWidth' : oGameData.imgWidth
                }
            });
            ...
            request.done( function(inData) {
                ...
                oGameData.timerId = setInterval(function() {
                    ...
                    */
                    ...
                    let width = oGameData.imgPositions[oGameData.antalSpoken].width;
                    let height = oGameData.imgPositions[oGameData.antalSpoken].height;
                    let left = oGameData.imgPositions[oGameData.antalSpoken].left;
                    let top = oGameData.imgPositions[oGameData.antalSpoken].top;
